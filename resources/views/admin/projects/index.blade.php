...
<div class="container flex-column d-flex justify-content-center align-items-center">
    ...
    <ul id="my-ul" class="mt-5">
        @foreach ($projects as $project)
            <li class="list-group-item mb-2"><a class="btn btn-dark text-white btn-sm" href="{{route('admin.projects.show', $project->slug)}}" title="View Project">{{$project->title}}</a></li>
